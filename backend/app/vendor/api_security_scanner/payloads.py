...
class SQLiPayloads:
    ...
    # NOTE (World Monitor integration): UNION_BASED, ERROR_BASED and
    # STACKED_QUERIES were removed from this vendored copy. They were never
    # referenced by any live scanner in the upstream project (verified by
    # grep) and include destructive statements such as DROP TABLE /
    # xp_cmdshell that must not ship inside an assessment platform.
    TIME_BASED_BLIND = [
        "'; WAITFOR DELAY '0:0:5'--",
